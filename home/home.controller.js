...
//
            ...
            function showFlash(flashindex) {
                ...
                if ($scope.flashQueue.length <= 0) {
                    ...
                    playSound("Attention .  Token No. "+ $scope.flashBus.body.token +". Patients . "+ $scope.flashBus.body.patientName +  " . please  proceed to the doctor .  " + $scope.flashBus.header.doctorName);
